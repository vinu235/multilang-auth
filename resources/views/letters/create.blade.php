                    ...
                    <div class="form-group">
                        ...
                        -->
                            <select name="type" id="type">
                                <option value="op1">FAST TRACK (CCO)</option>
                                <option value="op2">विभागीय कार्यालय (आरोग्य)</option>
                                <option value="op3">विभागीय आयुक्त</option>
                                <option value="op4">मंत्री संदर्भ </option>
                                <option value="op5">जि. प. पदाधिकारी सदस्य</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
